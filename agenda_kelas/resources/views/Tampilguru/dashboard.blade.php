          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0" style="padding-right: 150px">
              <li class="nav-item" style="padding-right: 30px">
                <a class="nav-link active" aria-current="page" href="/dashboardguru">Home</a>
              </li>
              <li class="nav-item" style="padding-right: 30px">
                        ...
                        <li class="sidebar-item  has-sub">
                            ...
                            <ul class="submenu ">
                                <li class="submenu-item ">
                                    <a href="/login-guru">AGENDA KELAS</a>
                                </li>
                            </ul>
                        </li>
                                ...
                                <div class="card" style="width: 250px">
                                    <div class="card-body px-3 py-4-5">
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                <a href="/login-guru"><h4 class="text-muted font-semibold pt-2">AGENDA KELAS</h4></a>  
                                            </div>
                                        </div>
                                    </div>
                                </div>
