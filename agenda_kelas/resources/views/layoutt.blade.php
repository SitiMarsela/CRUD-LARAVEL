                                ...
                                <div class="card" style="width: 250px">
                                    <div class="card-body px-3 py-4-5">
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                <a href="/guru"><h4 class="text-muted font-semibold pt-2">Data Guru</h4></a>  
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-6 col-lg-3 col-md-6 me-5 ms-5">
                                <div class="card" style="width: 250px">
                                    <div class="card-body px-3 py-4-5">
                                        <div class="row">
                                            <div class="col-md-4">
                                            ...
                                            <div class="col-md-8">
                                                <a href="/kelas"><h4 class="text-muted font-semibold pt-2">Data Kelas</h4></a>    
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-6 col-lg-3 col-md-6 ms-5">
                                <div class="card" style="width: 270px">
                                    <div class="card-body px-3 py-4-5">
                                        <div class="row">
                                            ...
                                            <div class="col-md-7">
                                                <a href="/agenda"><h4 class="text-muted font-semibold pt-2">Data Agenda</h4></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
